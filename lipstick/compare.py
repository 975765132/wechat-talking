import json
from lipstick import getcolor
import numpy as np
from lipstick import lipcolor
...
def data_operate(get):
    with open(r'lipstick\lipstick.json', 'r', encoding='utf-8') as f:
      ret_dic = json.load(f)
    ...
    #the third loop covert value_array to RGB_array#
      ...
      for i in range(3):
          idex=result[i]
          re_str += sum_list[idex][0] + " " + sum_list[idex][1] + " #" + sum_list[idex][2] + '\n'
          print(sum_list[idex])
